<?php
  ...
  if(isset($_POST['submit']))
  {
    ...
    $query="SELECT * FROM signupenterprauner where email='".$email."'";
    ...
    if($password===$conpassword)
     {
        $insert= "INSERT into signupenterprauner (name, email, password, confirm_password, DOB, bio) VALUES('$name','$email','$password','$conpassword', '$dob','$bio')";
        if(mysqli_query($connection, $insert))
        {
            $_SESSION['name'] = $name;
            $_SESSION['email']= $email;
            $_SESSION['type'] = "Enterprauner";
            header('location: enterpraunerprofilepic.php');
