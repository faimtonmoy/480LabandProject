...
else  
{
    ...
    $auth_query2="select photo from signupexpert where email='$check_auth'";
    ...
    <div class="container"><br><br>
        ...
        <?php
              ...
              $auth_query1="select bio from signupexpert where email='$check_auth'";
